  ...
  return (
    <div className="min-h-screen bg-surface-950 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-72 sm:w-96 h-72 sm:h-96 bg-brand-600/20 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 -right-40 w-72 sm:w-96 h-72 sm:h-96 bg-indigo-800/20 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-sm sm:max-w-md">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-white">ChatSphere</h1>
