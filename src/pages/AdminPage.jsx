...
export default function AdminPage() {
  ...
  return (
    <div className="h-screen h-[100dvh] w-full overflow-y-auto bg-surface-950">
      {/* Header */}
          ...
          <div className="space-y-4 animate-fade-in">
            <div className="flex items-center gap-3">
              <div className="relative flex-1">
                ...
                <input className="input-base" style={{ paddingLeft: "2.75rem" }} placeholder="Search users…" value={userSearch}
